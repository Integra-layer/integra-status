...
export const APP_GROUPS: AppGroup[] = [
  ...
  { id: "blockchain", name: "Blockchain Nodes", icon: "\u26D3\uFE0F", description: "EVM and Cosmos RPC/REST nodes for mainnet and testnet", endpoints: ["mainnet-evm-rpc", "mainnet-cosmos-rpc-adam", "mainnet-cosmos-rest-adam", "testnet-evm-rpc", "testnet-evm-rpc-ormos", "testnet-cosmos-rpc-ormos", "testnet-cosmos-rest-ormos"] },
...
export const ENDPOINTS: Endpoint[] = [
  // -- Blockchain (Mainnet -- integra-1, EVM chain 26217) --------------------
  {
    ...
    impactDescription: "Dashboard API and Explorer v2 lose EVM data — balances and transactions unavailable",
    ...
    owner: OWNERS.adam,
    links: { endpoint: "https://adamboudj.integralayer.com/rpc", docs: "https://docs.integralayer.com/nodes" },
